...
extern IMAGE img_selector_tip;		//选角色界面提示信息文本图片
extern IMAGE img_selector_background;	//选角色界面背景
...
extern IMAGE img_peashooter_selector_background_left;	//选角界面朝向左的豌豆射手的背景图片
extern IMAGE img_peashooter_selector_background_right;	//选角界面朝向右的豌豆射手的背景图片
extern IMAGE img_sunflower_selector_background_left;	//选角界面朝向左的向日葵的背景图片
extern IMAGE img_sunflower_selector_background_right;	//选角界面朝向右的向日葵的背景图片
...
public:
	...
	void on_exit()
	{
		...
		{
		case PlayerType::Peashooter:
			player_1 = new PeashooterPlayer(false);
			img_player_1_avatar = &img_avatar_peashooter;
			break;
		case PlayerType::Sunflower:
			player_1 = new SunflowerPlayer(false);
...
private:
	...
	int selector_background_scor11_offset_x = 0; //背景板滚动距离
