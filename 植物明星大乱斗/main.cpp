...
IMAGE img_selector_tip;		//选角色界面提示信息文本图片
IMAGE img_selector_background;	//选角色界面背景
...
IMAGE img_peashooter_selector_background_left;	//选角界面朝向左的豌豆射手的背景图片
IMAGE img_peashooter_selector_background_right;	//选角界面朝向右的豌豆射手的背景图片
IMAGE img_sunflower_selector_background_left;	//选角界面朝向左的向日葵的背景图片
IMAGE img_sunflower_selector_background_right;	//选角界面朝向右的向日葵的背景图片
...
Atlas atlas_peashooter_idle_left;	//豌豆射手朝向左默认图集
Atlas atlas_peashooter_idle_right;
Atlas atlas_peashooter_run_left;	//豌豆射手朝向左奔跑图集
Atlas atlas_peashooter_run_right;
Atlas atlas_peashooter_attack_ex_left;	//豌豆向左特殊攻击图集
Atlas atlas_peashooter_attack_ex_right;
Atlas atlas_peashooter_die_left;	//豌豆朝左死亡图集
...
Atlas atlas_sun;
Atlas atlas_sun_explode;	//阳光爆炸图集
Atlas atlas_sun_ex;			//特殊日光技能图集
Atlas atlas_sun_ex_explode;
Atlas atlas_sun_text;		//日文本图集
...
int main()
{
	...
	while (true)
	{
		...
		DWORD frame_datle_time = frame_end_time - frame_start_time;

		if (frame_datle_time < 1000 / FPS) {
			Sleep(1000 / FPS - frame_datle_time);
		}
	}
	EndBatchDraw();
}